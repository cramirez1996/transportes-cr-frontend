...
export class SidebarComponent implements OnInit {
  ...
  adminMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          route: '/admin/fleet/maintenance-types'
        },
        {
          label: 'Planes de Mantenimiento',
          icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01',
          route: '/admin/fleet/vehicle-maintenance-plans'
        },
      ]
    },
    { 
      ...
      children: [
        ...
        { 
          label: 'Categorías', 
          icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z', 
          route: '/admin/accounting/categories' 
        },
        {
          label: 'Explorador de Transacciones',
          icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
          route: '/admin/accounting/transaction-explorer'
        },
      ]
    },
    { 
    ...
    },
    {
      ...
      icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z M12 8v4m0 0l-2-2m2 2l2-2',
